...
module.exports = function (opts) {
    ...
    gulp.task('watch' + opts.config.taskPostfix, function () {
        const browserSyncReload = opts.browserSync.active ? [opts.browserSync.reload] : [];
        ...
        if (opts.config.project.styles && opts.config.project.styles.fusion && opts.config.project.styles.fusion.watch)
            gulp.watch(opts.config.project.styles.fusion.watch, gulp.series(['dist-css-fusion' + opts.config.taskPostfix].concat(browserSyncReload)));
        ...
        if (opts.config.project.scripts && opts.config.project.scripts.fusion && opts.config.project.scripts.fusion.watch)
            gulp.watch(opts.config.project.scripts.fusion.watch, gulp.series(['dist-js-fusion' + opts.config.taskPostfix].concat(browserSyncReload)));

        if (opts.config.project.scripts && opts.config.project.scripts.library && opts.config.project.scripts.library.watch)
            gulp.watch(opts.config.project.scripts.library.watch, gulp.series(['dist-js-library' + opts.config.taskPostfix].concat(browserSyncReload)));
        ...
        if (opts.config.project.scripts && opts.config.project.scripts.serviceWorker && opts.config.project.scripts.serviceWorker.source)
            gulp.watch(opts.config.project.scripts.serviceWorker.source, gulp.series(['dist-serviceworker' + opts.config.taskPostfix].concat(browserSyncReload)));
            ...
            for (let fallback of opts.config.fallbackChainConfig[opts.config.projectName]) {
                if (opts.allConfigs[fallback]) {
                    if (opts.allConfigs[fallback].project.styles && opts.allConfigs[fallback].project.styles.fusion && opts.allConfigs[fallback].project.styles.fusion.watch)
                        gulp.watch(opts.allConfigs[fallback].project.styles.fusion.watch, gulp.series(['dist-css-fusion' + opts.allConfigs[fallback].taskPostfix].concat(browserSyncReload)));
                    ...
                    if (opts.allConfigs[fallback].project.scripts && opts.allConfigs[fallback].project.scripts.fusion && opts.allConfigs[fallback].project.scripts.fusion.watch)
                        gulp.watch(opts.allConfigs[fallback].project.scripts.fusion.watch, gulp.series(['dist-js-fusion' + opts.allConfigs[fallback].taskPostfix].concat(browserSyncReload)));
                }
            }
        }
    });
